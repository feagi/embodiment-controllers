...
**Prerequisite:** FEAGI and Brain Visualizer must be started **before** launching any controller. See [FEAGI Installation](https://github.com/feagi/feagi/blob/main/DEPLOY.md) for setup.
