...
**Prerequisite:** FEAGI and Brain Visualizer must be started **before** launching any controller. See [FEAGI Installation Guide](https://github.com/feagi/feagi-python-sdk/blob/main/DEPLOY.md) for setup.
